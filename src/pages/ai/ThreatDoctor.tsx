...
import { useThreatDoctorChat, Message } from '@/hooks/useThreatDoctorChat';
...
export default function ThreatDoctor() {
  const { messages, isLoading, sendMessage, clearChat } = useThreatDoctorChat();
      ...
      <div className="flex items-center justify-between pb-4 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Intelligent Cybersecurity Assistant</p>
          </div>
        </div>
        {messages.length > 0 && (
